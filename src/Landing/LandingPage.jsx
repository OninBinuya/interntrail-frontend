      ...
      <div className="relative isolate px-6 pt-10 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[2000/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
